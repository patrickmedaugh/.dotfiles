...
set scrolloff=999 " cursor always in the center
...
noremap N Nzz
"
" remap line navigation to homerow
nnoremap H 0
nnoremap K ^
nnoremap L $

" press fm to fix indentation in whole file; overwrites marker 'q' position
noremap fm mqggVG=`qzz
